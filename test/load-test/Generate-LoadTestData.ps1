...
function New-ResourceRelationshipsFile {
...
function New-IdentityMembersFile {
...
function New-CertificationsFile {
...
# ─── Summary ─────────────────────────────────────────────────────
function Write-GeneratorSummary {
    $swatch.Stop()
    Write-Host ""
...
$resourceTypes     = @('Group','SAPRole','BusinessRole','AppRole','DirectoryRole','ApplicationRole')
...
New-ContextsFile
New-ResourcesFile
New-ResourceRelationshipsFile
New-UsersFile
New-AssignmentsFile
New-IdentitiesFile
New-IdentityMembersFile
New-CertificationsFile
Write-GeneratorSummary
