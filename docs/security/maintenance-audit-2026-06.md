...
| M3 | ✅ Fixed | #822 — Admin section emoji icons replaced with a shared inline-SVG set (`adminIcons.jsx`) (#755) |
...
| F9 | ✅ Fixed | #816 — Python added to CodeQL (separate `analyze-python` job); PSScriptAnalyzer already ran (#799) |
