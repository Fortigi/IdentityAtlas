...
| Q9–Q10 | 🟨 Partially addressed | #811 dropped the redundant jsonb parse (centralized in `lib/jsonb.js`); `400_000` is already the named `MAX_FLAT_ROWS`; `#microsoft.graph.group` centralization (11 files) still open |
