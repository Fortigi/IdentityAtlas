...
| H-04 | Several regions light-mode only (crawler job-detail modal, compliance & account-type badges) | ✅ Fixed | badges [#232](https://github.com/Fortigi/IdentityAtlas/pull/232) · job-detail modal [#817](https://github.com/Fortigi/IdentityAtlas/pull/817) |
