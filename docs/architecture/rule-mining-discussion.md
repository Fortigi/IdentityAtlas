...
Resource clusters are too coarse — a "HAMIS developer" and a "HAMIS user" need different roles. Clusters serve as **scoping / navigation**, not as the RHS of a rule.
