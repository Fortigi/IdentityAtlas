...
| `resourceType` | Free-form text — no enum check. Values currently emitted by crawlers: `Group`, `BusinessRole`, `Application`, `AppRole`, `DelegatedPermission`, `EntraDirectoryRole` |
