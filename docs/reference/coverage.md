...
|-------|------|--------|--------|------------|-----------|----------|---------------|
| [API (Node / Vitest — unit + contract)](../coverage/api/index.html) | 73.6% | 62.3% | 76.1% | — | — | — | 6,643 / 9,021 |
...
_Generated 2026-07-06 10:39 UTC from commit `0664634f`._
