...
- If the user asks a question (e.g. "what software does NSF use?"), research the answer, include it in assistantMessage, and also add any relevant facts to the profile (e.g. known_systems, critical_business_processes). Set profileChanged=true if you added anything.
