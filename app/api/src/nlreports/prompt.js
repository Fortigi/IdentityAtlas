...
2d. A yes/no question about ONE person and ONE named thing — "does X have the Y role", "is X a member of Y", "heeft X de rol Y", "zit X in groep Y" — is a report OF THAT THING: entity resource (group for a group) with displayName contains Y and members some with the person. One row means yes, no rows means no. Never a list of everything X holds.
