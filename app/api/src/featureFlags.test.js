...
describe('readFeatures', () => {
  it('answers with exactly the declared flags — this is the /api/features payload', async () => {
    ...
    expect(payload).toEqual({ riskScoring: false, accountLinking: true, experimentalCrawlers: true, matrixSharing: false, customReports: false, contextAssistant: false, teamsBot: false });
  });
});
