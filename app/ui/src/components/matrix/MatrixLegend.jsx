...
// The marker entries that exist only in a matrix showing business roles as
// foldable rows: the over-grant mark, the "held outside governance" count, a
// folded role's two tallies, and the BR chips. Without that layer the grid can
// never draw any of them, so listing them would be a key to symbols that aren't
// there.
function BusinessRoleRowMarkers() {
  return (
    <>
