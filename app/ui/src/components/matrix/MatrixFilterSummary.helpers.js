...
// "45 users × 39 resources · 127 cells" — the three live numbers of what the
...
export function stripCountsLabel(preview, rowType) {
  ...
  const cells = plural(preview.assignmentCount ?? 0, 'cell', 'cells');
  return `${subjects} × ${resources} · ${cells}`;
}
