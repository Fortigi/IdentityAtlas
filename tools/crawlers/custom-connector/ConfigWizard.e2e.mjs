 ...
 *
 * Named *.e2e.mjs, not *.spec.js, and exports register(test, expect) instead
 * of importing { test, expect } from '@playwright/test' directly — see
 * tools/crawlers/csv/ConfigWizard.e2e.mjs's header comment for why (no
 * ancestor node_modules containing @playwright/test from here).
 * app/ui/e2e/crawler-plugin-tests.spec.js discovers and loads this file.
 */
